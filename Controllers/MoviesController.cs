...
namespace AspNetCoreWebApiProject1.Controllers
{
    ...
    {
        private readonly AspNetCoreWebApiProject1.DataContext.DataContext _context;

        public MoviesController(AspNetCoreWebApiProject1.DataContext.DataContext context)
        {
            _context = context;
        }
